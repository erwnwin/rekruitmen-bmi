...
class Pelamar extends CI_Controller
{
    ...
    public function detail($id)
    {
        ...
        WHERE pelamar.id_job='$id' AND status_lamaran='Direkam' ")->result();
        ...
        $this->load->view('template/sidebar', $data);
        $this->load->view('template/header', $data);
        $this->load->view('admin/detail_pelamar', $data);
        $this->load->view('template/footer', $data);
    }

    public function detail_pelamar($id)
    {
        $data['title'] = "Detail Pelamar : PT BMI Makassar";
        $where = array('id_job' => $id);
        ...
        $this->load->view('template/sidebar', $data);
        $this->load->view('template/header', $data);
        $this->load->view('admin/detail_pelamar_per', $data);
        $this->load->view('template/footer', $data);
    }
}
