        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
                <div class="card text-white shadow" style="background-color: teal;">
                    <div class="card-body">
                        Selamat Datang Bapak/Ibu HRD PT BMI Makassar
                        <div class="text-white-50 small">Pada Sistem Informasi E-Rekrutmen PT BMI Makassar</div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Pengunjung Site</h6>
            ...
            <div class="col-xl-4 col-lg-5">
                <div class="card shadow mb-4">
                    <!-- Card Header - Dropdown -->
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Jumlah Pelamar</h6>
