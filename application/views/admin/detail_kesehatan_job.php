                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <div class="dropdown no-arrow">
                            <a href="<?= base_url('job-vacancies/create') ?>" class="btn btn-sm btn-success"><i class="fas fa-filter"></i> Filter Data</a>
                        </div>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($semua_pelamar as $j) { ?>
                                            <tr>
                                                ...
                                                <td><?= $j->nama_job ?></td>
                                                <td>
                                                    <a href="<?= base_url('kesehatan/create-score/' . $j->id_akun_pelamar) ?>" class="btn btn-sm btn-success"><i class="fas fa-edit"></i> Berikan Nilai Test Kesehatan</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
