        ...
        <?php foreach ($pelamar_det as $p) { ?>
            ...
            <div class="row">
                ...
                <div class="alert alert-danger" role="alert">
                    ...
                    <hr>
                    <p class="mb-0">
                        <button type="button" class="btn btn-success btn-sm mb-3" data-bs-toggle="modal" data-bs-target="#acc"> <i class="fas fa-check-circle"></i> Lanjut ke proses berikutnya</button>
                ...
                <!-- MODAL BERKAS -->
                <?php if ($p->status_lamaran == 'Direkam') { ?>
                        ...
                        <div class="modal fade" id="acc" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="accLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="<?= base_url('validasi/acc-berkas') ?>" method="post">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="hidden" class="form-control" name="status_lamaran" value="Berkas" readonly>
                            ...
                            <div class="modal-content">
                                <form action="<?= base_url('validasi/no-acc-berkas') ?>" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="hidden" class="form-control" name="no_wa" value="<?= $p->no_wa ?>" readonly>
                                        <input type="hidden" class="form-control" name="alamat_email" value="<?= $p->alamat_email ?>" readonly>
                                        <input type="hidden" class="form-control" name="status_lamarans" value="Tidak Lolos" readonly>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-success btn-sm">Setujui</button>
                                        <button type="button" class="btn btn-danger btn-sm" data-bs-dismiss="modal">Batal</button>
